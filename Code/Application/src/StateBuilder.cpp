...
State StateBuilder::createState(Timestamp Time, 
...
State StateBuilder::createState(Timestamp Time, Vector3D LinearAcceleration, Vector3D RotationalVelocity, Value GroundClearance)
{
	return State(LinearAcceleration, RotationalVelocity, GroundClearance, Time) - this->NullPoint_;
}
